/*********************************************************\
 *  File: PLSceneMaterialStandard.h                      *
 *
...
#ifndef __PL_SCENEMATERIAL_STANDARD_H__
#define __PL_SCENEMATERIAL_STANDARD_H__
#pragma once
...
*/
class PLSceneMaterialStandard : public PLSceneMaterial {
	...
	private:
		...
		*    Destructor
		*/
		virtual ~PLSceneMaterialStandard();
...
#endif // __PL_SCENEMATERIAL_STANDARD_H__
