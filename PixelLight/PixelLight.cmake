...
if(NOT CMAKETOOLS_MINIMAL)
	...
	set (PL_PLUGIN_PHYSICS_PHYSX				"1" CACHE BOOL "Build plugin 'PLPhysicsPhysX'? (due to legal issues, we can't provide a public downloadable package)")
	set (PL_PLUGIN_RENDERER_D3D9				"1" CACHE BOOL "Build plugin 'PLRendererD3D9'? (due to legal issues, we can't provide a public downloadable package)")
	set (PL_PLUGIN_RENDERER_D3D11				"1" CACHE BOOL "Build plugin 'PLRendererD3D11'? (due to legal issues, we can't provide a public downloadable package)")
	...
	set (PL_EXPORTER_3DSMAX_2008				"1" CACHE BOOL "Build exporter plugin 'PL3dsMaxSceneExport_2008'? (due to legal issues, we can't provide a public downloadable package)")
	set (PL_EXPORTER_3DSMAX_2009				"1" CACHE BOOL "Build exporter plugin 'PL3dsMaxSceneExport_2009'? (due to legal issues, we can't provide a public downloadable package)")
	set (PL_EXPORTER_3DSMAX_2010				"1" CACHE BOOL "Build exporter plugin 'PL3dsMaxSceneExport_2010'? (due to legal issues, we can't provide a public downloadable package)")
	set (PL_EXPORTER_3DSMAX_2011				"1" CACHE BOOL "Build exporter plugin 'PL3dsMaxSceneExport_2011'? (due to legal issues, we can't provide a public downloadable package)")
	set (PL_EXPORTER_3DSMAX_2012				"1" CACHE BOOL "Build exporter plugin 'PL3dsMaxSceneExport_2012'? (due to legal issues, we can't provide a public downloadable package)")
	...
	set (PL_PLUGIN_RENDERER_OPENGL				"1" CACHE BOOL "Build plugin 'PLRendererOpenGL'? (for font support, do also enable 'PL_PLUGIN_RENDERER_OPENGL_FONT') (due to legal issues, we can't provide a public downloadable package)")
	...
	set (PL_PLUGIN_SOUND_OPENSLES				"1" CACHE BOOL "Build plugin 'PLSoundOpenSLES'?")
	set (PL_PLUGIN_SOUND_FMOD					"1" CACHE BOOL "Build plugin 'PLSoundFMOD'? (due to legal issues, we can't provide a public downloadable package)")
	set (PL_PLUGIN_SOUND_FMODEX					"1" CACHE BOOL "Build plugin 'PLSoundFMODEx'? (due to legal issues, we can't provide a public downloadable package)")
	...
	if (PL_MOBILE)
		set (PL_PLUGIN_FRONTEND_OS				"1" CACHE BOOL "Build plugin 'PLFrontendOS'?")
		set (PL_PLUGIN_RENDERER_OPENGL			"0" CACHE BOOL "Build plugin 'PLRendererOpenGL'? (for font support, do also enable 'PL_PLUGIN_RENDERER_OPENGL_FONT') (due to legal issues, we can't provide a public downloadable package)")
