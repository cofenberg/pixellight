/*********************************************************\
 *  File: Main.cpp                                       *
 *      PixelLight Sample 21 - GuiWidgets
 *      GUI-Application demonstrating most of the PLGui widgets and features
 *
