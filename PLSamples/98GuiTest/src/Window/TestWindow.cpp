	...
	m_pButtonTopmost(nullptr)
{
	...
	m_pButtonFullscreen->EventClicked.Connect(&SlotOnToggleFullscreen);
	...
	m_pButtonTitleBar->EventClicked.Connect(&SlotOnToggleTitleBar);
	...
	m_pButtonBorder->EventClicked.Connect(&SlotOnToggleBorder);
	...
	m_pButtonTopmost->EventToggled.Connect(&SlotOnToggleTopmost);
	...
	m_pButtonTaskbar->EventToggled.Connect(&SlotOnToggleTaskbar);
