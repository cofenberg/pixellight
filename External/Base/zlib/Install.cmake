...
if(NOT EXISTS ${CMAKETOOLS_CURRENT_BUILT_FILE})
	...
	if(CMAKETOOLS_TARGET_SYSTEM_WIN32)
		external_copy("${CMAKETOOLS_CURRENT_BUILD_DIR}/build/zlib-1.2.3/projects/visualc6/Win32_LIB_Release/zlib.lib" "${CMAKETOOLS_CURRENT_LIB_DIR}/")
	elseif(CMAKETOOLS_TARGET_SYSTEM_LINUX)
		external_copy("${CMAKETOOLS_CURRENT_BUILD_DIR}/build/zlib-1.2.3/libz.a" "${CMAKETOOLS_CURRENT_LIB_DIR}/")
	endif()

	# Copy headers
	external_makedir("${CMAKETOOLS_CURRENT_INCLUDE_DIR}/zlib")
	external_copy("${CMAKETOOLS_CURRENT_BUILD_DIR}/build/zlib-1.2.3/zconf.h" "${CMAKETOOLS_CURRENT_INCLUDE_DIR}/zlib/")
	external_copy("${CMAKETOOLS_CURRENT_BUILD_DIR}/build/zlib-1.2.3/zlib.h" "${CMAKETOOLS_CURRENT_INCLUDE_DIR}/zlib/")
