...
class Type<T*> {
	...
	public:
		...
		{
			return static_cast<int>(static_cast<PLGeneral::uint_ptr>(pValue));
		}
		...
		{
			return static_cast<PLGeneral::int8>(static_cast<PLGeneral::uint_ptr>(pValue));
		}
		...
		{
			return static_cast<PLGeneral::int16>(static_cast<PLGeneral::uint_ptr>(pValue));
		}
		...
		{
			return static_cast<PLGeneral::int32>(static_cast<PLGeneral::uint_ptr>(pValue));
		}
		...
		{
			return static_cast<PLGeneral::int64>(static_cast<PLGeneral::uint_ptr>(pValue));
		}
		...
		{
			return static_cast<PLGeneral::uint8>(static_cast<PLGeneral::uint_ptr>(pValue));
		}
		...
		{
			return static_cast<PLGeneral::uint16>(static_cast<PLGeneral::uint_ptr>(pValue));
		}
		...
		{
			return static_cast<PLGeneral::uint32>(static_cast<PLGeneral::uint_ptr>(pValue));
		}
		...
		{
			return static_cast<PLGeneral::uint64>(static_cast<PLGeneral::uint_ptr>(pValue));
		}
		...
		{
			return static_cast<PLGeneral::uint_ptr>(pValue);
		}
