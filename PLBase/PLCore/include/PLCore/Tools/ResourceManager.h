...
template <class AType> class ResourceManager {
	...
	public:
		...
		*/
		PLGeneral::String GetManagerName() const;
		...
		*    - GetManagerName()
		*/
		bool SetManagerName(const PLGeneral::String &sName = "");
		...
		*/
		AType *Create(const PLGeneral::String &sName = "");
		...
		*/
		PLGeneral::uint32 GetNumOfElements() const;
	...
	public:
		...
		*    resource creation.
		*/
		virtual AType *LoadResource(const PLGeneral::String &sFilename);
	...
	protected:
		...
		*/
		bool SetResourceName(AType &cResource, const PLGeneral::String &sName);
	...
	protected:
		...
		*/
		virtual AType *CreateResource(const PLGeneral::String &sName = "") = 0;
...
//[ Implementation                                        ]
//[-------------------------------------------------------]
#include "PLCore/Tools/ResourceManager.inl"
