...
#ifndef __PLGENERAL_DYNLIB_H__
#define __PLGENERAL_DYNLIB_H__
#pragma once
...
class DynLib {
	...
	public:
		...
		*/
		PLGENERAL_API bool Load(const String &sPath);
		...
		*/
		PLGENERAL_API bool IsLoaded() const;
		...
		*/
		PLGENERAL_API String GetAbsPath() const;
