...
#ifndef __PLGENERAL_FILE_H__
#define __PLGENERAL_FILE_H__
#pragma once
...
class File : public FileObject {
	...
	//[-------------------------------------------------------]
	public:
		PLGENERAL_API static File StandardInput;	/**< Standard OS input stream (stdin) */
		PLGENERAL_API static File StandardOutput;	/**< Standard OS output stream (stdout) */
		PLGENERAL_API static File StandardError;	/**< Standard OS error stream (stderr) */
	...
	public:
		...
		*/
		PLGENERAL_API File(FILE *pFile, uint32 nAccess);
		...
		*/
		PLGENERAL_API File(handle hFile);
		...
		*    URL of a file
		*/
		PLGENERAL_API File(uint8 *pnData, uint32 nNumOfBytes, bool bCopy = true, const String &sUrl = "");

		/**
		*  @brief
		*    Destructor
		*/
		PLGENERAL_API virtual ~File();
		...
		*/
		PLGENERAL_API bool Create(bool bAlways = false);
		...
		*/
		PLGENERAL_API bool Open(uint32 nAccess);
		...
		*    - GetMemoryBuffer()
		*/
		PLGENERAL_API bool IsMemoryBuffered() const;
		...
		*/
		PLGENERAL_API bool IsReadable() const;
		...
		*/
		PLGENERAL_API bool IsWritable() const;
		...
		*/
		PLGENERAL_API bool PutC(int nChar);
		...
		*/
		PLGENERAL_API int PutS(const String &sString);
		...
		*/
		PLGENERAL_API uint32 Write(const void *pBuffer, uint32 nSize, uint32 nCount);
		...
		*    'true' if all went fine, else 'false'
		*/
		PLGENERAL_API bool Seek(int32 nOffset = 0, ESeek nLocation = SeekSet);
		...
		*    'true' if all went fine, else 'false'
		*/
		PLGENERAL_API bool Print(const String &sString);
		...
		*    'true' if all went fine, else 'false'
		*/
		PLGENERAL_API bool PrintLn(const String &sString);
