...
#ifndef __PLGENERAL_LOGFORMATER_HTML_H__
#define __PLGENERAL_LOGFORMATER_HTML_H__
#pragma once
...
class LogFormaterHtml : public LogFormater {
	...
	public:
		...
		*    Default constructor
		*/
		PLGENERAL_API LogFormaterHtml();

		/**
		*  @brief
		*    Destructor
		*/
		PLGENERAL_API virtual ~LogFormaterHtml();
		...
		*/
		PLGENERAL_API void SetTextFormat(uint8 nLogLevel, const String &sFormat);
		...
		*/
		PLGENERAL_API void SetHeader(const String &sHeader = "");
		...
		*    The log's title
		*/
		PLGENERAL_API void SetTitle(const String &sTitle = "PL-Log");
		...
		*/
		PLGENERAL_API void SetBackground(const String &sBackground = "");
		...
		*/
		PLGENERAL_API void SetDefaultTextColor(const String &sColor = "black");
		...
		*    - See SetTextFormat()
		*/
		PLGENERAL_API void SetDefaultTextFormat(const String &sFormat = "|<br>");
		...
		*    Footer text
		*/
		PLGENERAL_API void SetFooter(const String &sFooter = "");
...
#endif // __PLGENERAL_LOGFORMATER_HTML_H__
