...
#ifndef __PLGENERAL_LOGFORMATER_H__
#define __PLGENERAL_LOGFORMATER_H__
#pragma once
...
class LogFormater {
	...
	public:
		...
		*/
		PLGENERAL_API void ShowLogLevelPrefix(bool bShow = true);
	...
	protected:
		...
		*    Default constructor
		*/
		PLGENERAL_API LogFormater();

		/**
		*  @brief
		*    Destructor
		*/
		PLGENERAL_API virtual ~LogFormater();
...
#endif // __PLGENERAL_LOGFORMATER_H__
