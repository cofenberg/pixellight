...
#ifndef __PLGENERAL_LOG_H__
#define __PLGENERAL_LOG_H__
#pragma once
...
#define PL_LOG(Level, Text) { \
	if (PLGeneral::Log::GetInstance()->GetLogLevel() >= PLGeneral::Log::Level) { \
		PLGeneral::Log::LogLevel nLogLevel = PLGeneral::Log::Level; /* Avoid 'expression is constant' warning */ \
		if (nLogLevel >= PLGeneral::Log::Debug) { \
			PLGeneral::String sLogString = Text; \
			PLGeneral::Log::GetInstance()->Output(PLGeneral::Log::Level, sLogString + PLGeneral::String::Format(", %s, %d, %s", __FILE__, __LINE__, __FUNCTION__)); \
		} else PLGeneral::Log::GetInstance()->Output(PLGeneral::Log::Level, Text); \
	} \
}
...
class Log : public Singleton<Log> {
	...
	public:
		...
		*/
		PLGENERAL_API bool IsVerbose() const;
		...
		*/
		PLGENERAL_API bool Open(const String &sFilename, LogFormater &cLogFormater);
		...
		*/
		PLGENERAL_API bool Output(uint8 nLogLevel, const String &sText);
		...
		*/
		PLGENERAL_API uint8 GetLogLevel() const;
		...
		*/
		PLGENERAL_API void SetLogLevel(uint8 nLogLevel = Info);
		...
		*/
		PLGENERAL_API uint8 GetFlushLogLevel() const;
		...
		*/
		PLGENERAL_API void SetFlushLogLevel(uint8 nFlushLogLevel = Error);
		...
		*/
		PLGENERAL_API uint32 GetBufferCount() const;
		...
		*/
		PLGENERAL_API void SetBufferCount(uint32 nBufferCount = 10);
		...
		*/
		PLGENERAL_API const Queue<String> &GetLastMessages() const;
		...
		*/
		PLGENERAL_API String LogLevelToString(uint8 nLogLevel) const;
