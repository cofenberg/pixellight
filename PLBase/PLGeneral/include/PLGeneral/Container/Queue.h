...
class Queue {
	...
	private:
		...
		*/
		struct QueueElement {
			QueueElement *pNext;	/**< Pointer to the next element on the queue, can be NULL */
	...
	private:
		...
		QueueElement *m_pTop;			/**< Pointer to the top element, can be NULL */
		QueueElement *m_pBottom;		/**< Pointer to the bottom element, can be NULL */
