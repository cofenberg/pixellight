...
#ifndef __PLGENERAL_WRAPPER_H__
#define __PLGENERAL_WRAPPER_H__
#pragma once
...
class Wrapper {
	...
	public:
		...
		*    - 'strlen'-wrapper
		*/
		PLGENERAL_API static uint32 GetStringLength(const char szString[]);
		...
		*/
		PLGENERAL_API static float Ceil(float fValue);
		...
		*/
		PLGENERAL_API static float Log(float x);
