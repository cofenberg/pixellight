...
#ifndef __PLGENERAL_CHECKSUMMD5_H__
#define __PLGENERAL_CHECKSUMMD5_H__
#pragma once
...
class ChecksumMD5 : public Checksum {
	...
	public:
		...
		*    Default constructor
		*/
		PLGENERAL_API ChecksumMD5();

		/**
		*  @brief
		*    Destructor
		*/
		PLGENERAL_API virtual ~ChecksumMD5();
...
#endif // __PLGENERAL_CHECKSUMMD5_H__
