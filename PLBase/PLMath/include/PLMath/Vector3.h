...
class Vector3 {
	...
	//[-------------------------------------------------------]
	public:
		PLMATH_API static const Vector3 Zero;			/**<  0.0,  0.0,  0.0 */
		PLMATH_API static const Vector3 One;			/**<  1.0,  1.0,  1.0 */
		PLMATH_API static const Vector3 NegativeOne;	/**< -1.0, -1.0, -1.0 */
		PLMATH_API static const Vector3 UnitX;			/**<  1.0,  0.0,  0.0 */
		PLMATH_API static const Vector3 UnitY;			/**<  0.0,  1.0,  0.0 */
		PLMATH_API static const Vector3 UnitZ;			/**<  0.0,  0.0,  1.0 */
		PLMATH_API static const Vector3 NegativeUnitX;	/**< -1.0,  0.0,  0.0 */
		PLMATH_API static const Vector3 NegativeUnitY;	/**<  0.0, -1.0,  0.0 */
		PLMATH_API static const Vector3 NegativeUnitZ;	/**<  0.0,  0.0, -1.0 */
