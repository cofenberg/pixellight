...
class Matrix4x4 {
	...
	//[-------------------------------------------------------]
	public:
		PLMATH_API static const Matrix4x4 Zero;		/**< Zero matrix */
		PLMATH_API static const Matrix4x4 Identity;	/**< Identity matrix */
	...
	public:
		...
		*    @endcode
		*/
		inline Vector4 GetColumn(PLGeneral::uint8 nColumn) const;
		...
		*    - GetColumn()
		*/
		inline void SetColumn(PLGeneral::uint8 nColumn, const Vector4 &vColumn);
