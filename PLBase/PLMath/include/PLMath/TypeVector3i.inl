...
class Type<PLMath::Vector3i> {
	...
	public:
		...
		{
			return PLMath::Vector3i((int)nValue, (int)nValue, (int)nValue);
		}
		...
		{
			return PLMath::Vector3i((int)fValue, (int)fValue, (int)fValue);
		}
		...
		{
			return PLMath::Vector3i((int)dValue, (int)dValue, (int)dValue);
		}
