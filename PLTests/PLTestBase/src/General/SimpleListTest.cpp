...
//[-------------------------------------------------------]
const char *SimpleListTest::GetName() const
{
	return "SimpleList";
}
...
//[-------------------------------------------------------]
void SimpleListTest::Test()
{
	// Perform general tests
	SimpleList<bool> cContainer;
	bool bResult;
	...
	{ // Check iterator from 0 -> (NumOfElements-1)
		...
		Iterator<bool> cIterator = cContainer.GetIterator();
		bResult = true;
	...
	{ // Check iterator from (NumOfElements-1) -> 0
		...
		Iterator<bool> cIterator = cContainer.GetEndIterator();
		bResult = true;
