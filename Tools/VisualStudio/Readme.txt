...
Description:
- Contains rules on how to display PixelLight data types, e.g. a PLCore::String will be displayed
...
- When using "step into" while debugging your application, you automatically step into every function present
  ...
  E.g. when you have a function named 'Test', which you want to debug, and that functions takes a PLCore::String
  as an argument:
    Test("Hello")
  By "stepping into" this expression, the debugger will first jump into the constructor of PLCore::String,
...
- Supported classes:
  - PLCore::String
  - PLCore::Singleton
  - PLCore::MemoryManager and global operators new, new[], delete, delete[]
