...
#ifndef __PL_SCENEHELPER_H__
#define __PL_SCENEHELPER_H__
#pragma once
...
/**
*  @brief
*    Exported PixelLight helper
*/
class PLSceneHelper : public PLSceneNode {
