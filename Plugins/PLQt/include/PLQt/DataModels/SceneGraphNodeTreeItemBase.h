...
#ifndef __PLQT_SCENEGRAPHNODETREEITEMBASE_H__
#define __PLQT_SCENEGRAPHNODETREEITEMBASE_H__
#pragma once
...
class SceneGraphNodeTreeItemBase : public TreeItemBase {
	...
	//[-------------------------------------------------------]
	public:
		explicit SceneGraphNodeTreeItemBase(QObject *parent = nullptr);
...
#endif // __PLQT_SCENEGRAPHNODETREEITEMBASE_H__
