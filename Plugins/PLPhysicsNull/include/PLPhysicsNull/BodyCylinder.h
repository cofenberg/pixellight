...
#ifndef __PLPHYSICSNULL_BODYCYLINDER_H__
#define __PLPHYSICSNULL_BODYCYLINDER_H__
#pragma once
...
/**
*  @brief
*    Null physics cylinder body implementation
*/
class BodyCylinder : public PLPhysics::BodyCylinder {
	...
	public:
		...
		*    Destructor
		*/
		PLPHYSICSNULL_API virtual ~BodyCylinder();
...
#endif // __PLPHYSICSNULL_BODYCYLINDER_H__
