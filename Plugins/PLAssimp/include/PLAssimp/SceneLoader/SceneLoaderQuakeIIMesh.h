...
*/
class SceneLoaderQuakeIIMesh : public PLScene::SceneLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, SceneLoaderQuakeIIMesh, "PLAssimp", PLScene::SceneLoader, "Scene loader implementation for md2 (Quake II mesh) using Assimp")
		// Properties
		pl_properties
