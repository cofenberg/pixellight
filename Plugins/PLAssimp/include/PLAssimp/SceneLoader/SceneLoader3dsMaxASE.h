...
*/
class SceneLoader3dsMaxASE : public PLScene::SceneLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, SceneLoader3dsMaxASE, "PLAssimp", PLScene::SceneLoader, "Scene loader implementation for ase (3D Studio Max ASCII Export) using Assimp")
		// Properties
		pl_properties
