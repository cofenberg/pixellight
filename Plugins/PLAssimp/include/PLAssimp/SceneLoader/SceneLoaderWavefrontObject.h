...
*/
class SceneLoaderWavefrontObject : public PLScene::SceneLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, SceneLoaderWavefrontObject, "PLAssimp", PLScene::SceneLoader, "Scene loader implementation for obj (Wavefront Object) using Assimp")
		// Properties
		pl_properties
