...
*/
class SceneLoaderStereolithography : public PLScene::SceneLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, SceneLoaderStereolithography, "PLAssimp", PLScene::SceneLoader, "Scene loader implementation for stl (Stereolithography) using Assimp")
		// Properties
		pl_properties
