...
*/
class SceneLoaderMilkshape3D : public PLScene::SceneLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, SceneLoaderMilkshape3D, "PLAssimp", PLScene::SceneLoader, "Scene loader implementation for ms3d (Milkshape 3D) using Assimp")
		// Properties
		pl_properties
