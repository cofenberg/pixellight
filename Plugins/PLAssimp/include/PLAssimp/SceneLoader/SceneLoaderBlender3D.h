...
*/
class SceneLoaderBlender3D : public PLScene::SceneLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, SceneLoaderBlender3D, "PLAssimp", PLScene::SceneLoader, "Scene loader implementation for blend (Blender 3D) using Assimp")
		// Properties
		pl_properties
