...
*/
class SceneLoaderLightWave : public PLScene::SceneLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, SceneLoaderLightWave, "PLAssimp", PLScene::SceneLoader, "Scene loader implementation for lwo (LightWave) using Assimp")
		// Properties
		pl_properties
