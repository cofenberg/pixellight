...
*/
class MeshLoaderNeutralFileFormat : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderNeutralFileFormat, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for nff (Neutral File Format) using Assimp")
		// Properties
		pl_properties
