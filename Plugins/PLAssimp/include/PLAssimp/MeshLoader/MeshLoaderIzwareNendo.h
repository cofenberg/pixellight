...
*/
class MeshLoaderIzwareNendo : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderIzwareNendo, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for ndo (Izware Nendo) using Assimp")
		// Properties
		pl_properties
