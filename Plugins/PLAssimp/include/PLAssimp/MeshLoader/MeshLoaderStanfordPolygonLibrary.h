...
*/
class MeshLoaderStanfordPolygonLibrary : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderStanfordPolygonLibrary, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for ply (Stanford Polygon Library) using Assimp")
		// Properties
		pl_properties
