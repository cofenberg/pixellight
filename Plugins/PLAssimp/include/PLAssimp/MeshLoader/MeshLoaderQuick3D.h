...
*/
class MeshLoaderQuick3D : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderQuick3D, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for q3d/q3s (Quick3D) using Assimp")
		// Properties
		pl_properties
