...
*/
class MeshLoaderStereolithography : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderStereolithography, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for stl (Stereolithography) using Assimp")
		// Properties
		pl_properties
