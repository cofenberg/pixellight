...
*/
class MeshLoaderObjectFileFormat : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderObjectFileFormat, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for off (Object File Format) using Assimp")
		// Properties
		pl_properties
