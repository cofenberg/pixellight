...
*/
class MeshLoaderBlitzBasic3D : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderBlitzBasic3D, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for b3d (BlitzBasic 3D) using Assimp")
		// Properties
		pl_properties
