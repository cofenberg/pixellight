...
*/
class MeshLoaderTerragenTerrain : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderTerragenTerrain, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for ter (Terragen Terrain) using Assimp")
		// Properties
		pl_properties
