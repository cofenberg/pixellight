...
*/
class MeshLoaderSense8WorldToolKit : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderSense8WorldToolKit, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for nff (Sense8 WorldToolKit) using Assimp")
		// Properties
		pl_properties
