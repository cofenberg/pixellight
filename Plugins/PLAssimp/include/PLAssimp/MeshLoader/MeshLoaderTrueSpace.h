...
*/
class MeshLoaderTrueSpace : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderTrueSpace, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for cob/scn (TrueSpace) using Assimp")
		// Properties
		pl_properties
