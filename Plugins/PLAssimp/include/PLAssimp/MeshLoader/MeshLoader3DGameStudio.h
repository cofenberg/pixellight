...
*/
class MeshLoader3DGameStudio : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoader3DGameStudio, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for mdl (3D GameStudio) using Assimp")
		// Properties
		pl_properties
