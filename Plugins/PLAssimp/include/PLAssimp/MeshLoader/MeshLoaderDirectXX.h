...
*/
class MeshLoaderDirectXX : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderDirectXX, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for x (DirectX X) using Assimp")
		// Properties
		pl_properties
