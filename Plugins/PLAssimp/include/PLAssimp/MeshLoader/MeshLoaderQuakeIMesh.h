...
*/
class MeshLoaderQuakeIMesh : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderQuakeIMesh, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for mdl (Quake I mesh) using Assimp")
		// Properties
		pl_properties
