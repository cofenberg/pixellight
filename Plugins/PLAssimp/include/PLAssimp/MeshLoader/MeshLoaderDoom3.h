...
*/
class MeshLoaderDoom3 : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderDoom3, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for md5 (Doom 3) using Assimp")
		// Properties
		pl_properties
