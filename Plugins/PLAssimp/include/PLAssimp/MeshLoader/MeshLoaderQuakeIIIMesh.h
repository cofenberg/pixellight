...
*/
class MeshLoaderQuakeIIIMesh : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderQuakeIIIMesh, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for md3 (Quake III mesh) using Assimp")
		// Properties
		pl_properties
