...
*/
class MeshLoaderPovRAYRaw : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderPovRAYRaw, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for raw (PovRAY Raw) using Assimp")
		// Properties
		pl_properties
