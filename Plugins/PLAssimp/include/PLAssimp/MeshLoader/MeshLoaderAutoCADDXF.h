...
*/
class MeshLoaderAutoCADDXF : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderAutoCADDXF, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for dxf (AutoCAD DXF) using Assimp")
		// Properties
		pl_properties
