...
*/
class MeshLoader3DGameStudioTerrain : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoader3DGameStudioTerrain, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for hmp (3D GameStudio Terrain) using Assimp")
		// Properties
		pl_properties
