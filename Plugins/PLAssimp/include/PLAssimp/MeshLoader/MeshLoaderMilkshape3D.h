...
*/
class MeshLoaderMilkshape3D : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderMilkshape3D, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for ms3d (Milkshape 3D) using Assimp")
		// Properties
		pl_properties
