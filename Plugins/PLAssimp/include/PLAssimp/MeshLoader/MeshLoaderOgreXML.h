...
*/
class MeshLoaderOgreXML : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderOgreXML, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for mesh.xml (Ogre XML) using Assimp")
		// Properties
		pl_properties
