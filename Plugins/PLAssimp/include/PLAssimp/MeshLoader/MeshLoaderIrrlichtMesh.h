...
*/
class MeshLoaderIrrlichtMesh : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderIrrlichtMesh, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for irrmesh (Irrlicht Mesh) using Assimp")
		// Properties
		pl_properties
