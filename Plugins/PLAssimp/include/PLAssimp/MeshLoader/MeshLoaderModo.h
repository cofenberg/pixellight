...
*/
class MeshLoaderModo : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderModo, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for lxo (Modo) using Assimp")
		// Properties
		pl_properties
