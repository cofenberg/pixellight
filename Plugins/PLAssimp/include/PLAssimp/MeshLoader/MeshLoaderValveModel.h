...
*/
class MeshLoaderValveModel : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderValveModel, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for smd/vta (Valve Model) using Assimp")
		// Properties
		pl_properties
