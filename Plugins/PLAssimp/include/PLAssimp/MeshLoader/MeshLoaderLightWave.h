...
*/
class MeshLoaderLightWave : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderLightWave, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for lwo (LightWave) using Assimp")
		// Properties
		pl_properties
