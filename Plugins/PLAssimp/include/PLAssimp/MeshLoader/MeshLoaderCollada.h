...
*/
class MeshLoaderCollada : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderCollada, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for dae (Collada) using Assimp")
		// Properties
		pl_properties
