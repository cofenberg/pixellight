...
*/
class MeshLoaderBlender3D : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoaderBlender3D, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for blend (Blender 3D) using Assimp")
		// Properties
		pl_properties
