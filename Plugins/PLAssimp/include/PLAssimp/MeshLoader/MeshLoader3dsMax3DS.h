...
*/
class MeshLoader3dsMax3DS : public PLMesh::MeshLoader {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, MeshLoader3dsMax3DS, "PLAssimp", PLMesh::MeshLoader, "Mesh loader implementation for 3ds (3D Studio Max) using Assimp")
		// Properties
		pl_properties
