...
pl_module_plugin("PLDatabaseMySQL")
	...
	pl_module_dependencies_win32_release("libmySQL.dll")
	pl_module_dependencies_win32_debug("libmySQL.dll")
	pl_module_dependencies_win64_release("libmySQL64.dll")
	pl_module_dependencies_win64_debug("libmySQL64.dll")
pl_module_end
