...
#ifndef __PLRENDERERNULL_TEXTUREBUFFERCUBE_H__
#define __PLRENDERERNULL_TEXTUREBUFFERCUBE_H__
#pragma once
...
/**
*  @brief
*    Null cube texture buffer resource
*/
...
#endif // __PLRENDERERNULL_TEXTUREBUFFERCUBE_H__
