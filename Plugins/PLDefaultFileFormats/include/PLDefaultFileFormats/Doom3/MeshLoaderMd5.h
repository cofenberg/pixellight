...
class MeshLoaderMd5 : public PLMesh::MeshLoader {
	...
	private:
		...
		*/
		bool LoadV6(PLMesh::Mesh &cMesh, PLCore::Tokenizer &cTokenizer, bool bStatic = false) const;
		...
		*    'true' if all went fine, else 'false'
		*/
		bool LoadV10(PLMesh::Mesh &cMesh, PLCore::Tokenizer &cTokenizer, bool bStatic = false) const;
