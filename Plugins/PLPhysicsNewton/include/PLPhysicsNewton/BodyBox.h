...
#ifndef __PLPHYSICSNEWTON_BODYBOX_H__
#define __PLPHYSICSNEWTON_BODYBOX_H__
#pragma once
...
/**
*  @brief
*    Newton physics box body implementation
*/
class BodyBox : public PLPhysics::BodyBox {
	...
	public:
		...
		*    Destructor
		*/
		PLPHYSICSNEWTON_API virtual ~BodyBox();
...
#endif // __PLPHYSICSNEWTON_BODYBOX_H__
