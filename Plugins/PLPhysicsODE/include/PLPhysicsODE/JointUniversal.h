...
#ifndef __PLPHYSICSODE_JOINTUNIVERSAL_H__
#define __PLPHYSICSODE_JOINTUNIVERSAL_H__
#pragma once
...
/**
*  @brief
*    ODE physics universal joint implementation
*/
class JointUniversal : public PLPhysics::JointUniversal {
	...
	public:
		...
		*    Destructor
		*/
		PLPHYSICSODE_API virtual ~JointUniversal();
	...
	//[-------------------------------------------------------]
	public:
		PLPHYSICSODE_API virtual void AddOmega(float fOmega1, float fOmega2) override;
...
#endif // __PLPHYSICSODE_JOINTUNIVERSAL_H__
