...
uniform highp vec4 PointParameters;					// Point parameters: point size, point scale a, point scale b, point scale c \n\
\n\
// Programs\n\
void main()\n\
{\n\
...
\n\
	...
	float dist_atten = 1.0/(PointParameters.y + PointParameters.z*distance + PointParameters.w*distance*distance);\n\
