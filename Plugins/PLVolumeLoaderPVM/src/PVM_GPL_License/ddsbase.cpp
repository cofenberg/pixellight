...
PL_WARNING_DISABLE(4244) // "warning C4244: '=' : conversion from 'int' to 'unsigned char', possible loss of data"
PL_WARNING_DISABLE(4996) // "warning C4996: '_snprintf': This function or variable may be unsafe. Consider using _snprintf_s instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."


#include "PLVolumeLoaderPVM/PVM_GPL_License/codebase.h" // universal code base
#include "PLVolumeLoaderPVM/PVM_GPL_License/ddsbase.h"
