...
- nvidia-cg-toolkit (required by PLRendererOpenGLCg - >= Cg Toookit 3.0 - November 2010 required)
	- "nvidia-cg-toolkit" may be out-of-date, install a newer Cg SDK: http://developer.download.nvidia.com/cg/Cg_3.0/Cg-3.0_November2010_x86.deb
