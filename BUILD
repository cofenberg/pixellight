...
- nvidia-cg-toolkit (required by PLRendererOpenGLCg - >= Cg Toolkit 3.0 - February 2011 required)
	- "nvidia-cg-toolkit" may be out-of-date, install a newer Cg SDK: http://developer.download.nvidia.com/cg/Cg_3.0/Cg-3.0_February2011_x86.deb
...
- PixelLight requires at least Android 2.3 (Gingerbread, NDK API level 9), previous Android versions had no decent native support
