/*********************************************************\
 *  File: Main.cpp                                       *
 *      This demo will use three frames. In two frames the triangle
 *      and teapot demo scenes will be shown. The main frame consists
