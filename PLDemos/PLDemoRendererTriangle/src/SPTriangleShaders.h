...
#ifndef __PLDEMORENDERERTRIANGLE_SURFACEPAINTER_SHADERS_H__
#define __PLDEMORENDERERTRIANGLE_SURFACEPAINTER_SHADERS_H__
#pragma once
...
#endif // __PLDEMORENDERERTRIANGLE_SURFACEPAINTER_SHADERS_H__
