...
#ifndef __PLDEMOSPARK_PL_SNGRAVITATIONDEMO_H__
#define __PLDEMOSPARK_PL_SNGRAVITATIONDEMO_H__
#pragma once
...
*/
class SNGravitationDemo : public SPARK_PL::SNSystem {
...
#endif // __PLDEMOSPARK_PL_SNGRAVITATIONDEMO_H__
