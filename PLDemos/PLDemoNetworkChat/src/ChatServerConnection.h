...
#ifndef __PLDEMONETWORKCHAT_CHATSERVERCONNECTION_H__
#define __PLDEMONETWORKCHAT_CHATSERVERCONNECTION_H__
#pragma once
...
#endif // __PLDEMONETWORKCHAT_CHATSERVERCONNECTION_H__
