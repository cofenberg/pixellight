/*********************************************************\
 *  File: Main.cpp                                       *
 *      PixelLight demo showing how to use "PLEngine::ScriptApplication" in order to load in and execute a scripted stand-alone application
 *
...
//[-------------------------------------------------------]
pl_module("PLDemoScriptApplication")
	pl_module_vendor("Copyright (C) 2002-2011 by The PixelLight Team")
	pl_module_license("GNU Lesser General Public License as published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version")
	pl_module_description("PixelLight demo showing how to use \"PLEngine::ScriptApplication\" in order to load in and execute a scripted stand-alone application")
pl_module_end
