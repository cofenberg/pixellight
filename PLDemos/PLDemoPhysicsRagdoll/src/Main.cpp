/*********************************************************\
 *  File: Main.cpp                                       *
 *      This demo demonstrates how to use physics plugins within a PixelLight application.
 *      Because this demo is quite simple it is in fact physics API independant. We espect
 *      that every physics plugin is using the name convention
 *      <Name of the physics API><World>
 *      Using such names, this demo application can create a list of all supported physics
