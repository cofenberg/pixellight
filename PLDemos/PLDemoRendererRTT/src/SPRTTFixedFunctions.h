...
#ifndef __PLDEMORENDERERRTT_SURFACEPAINTER_FIXEDFUNCTION_H__
#define __PLDEMORENDERERRTT_SURFACEPAINTER_FIXEDFUNCTION_H__
#pragma once
...
#endif // __PLDEMORENDERERRTT_SURFACEPAINTER_FIXEDFUNCTION_H__
