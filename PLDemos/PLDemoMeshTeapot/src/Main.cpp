/*********************************************************\
 *  File: Main.cpp                                       *
 *      This is a very basic demo showing how to use meshes
 *      created with the mesh creator and a simple light.
 *
