...
#ifndef __PLDEMORENDERERTEXTURING_SURFACEPAINTER_H__
#define __PLDEMORENDERERTEXTURING_SURFACEPAINTER_H__
#pragma once
...
#endif // __PLDEMORENDERERTEXTURING_SURFACEPAINTER_H__
