##################################################
## Toolchain for building with Android NDK toolchain
##################################################

# Toolchain name
set(CMAKETOOLS_TOOLCHAIN ndk)

# Don't use inline-assembler
set(CMAKETOOLS_CONFIG_NO_INLINE_ASM 1)

# Internal options
#set(CMAKETOOLS_TARGET_ARCH	${ANDROID_NDK_ABI_NAME})	# Set at the end of this file, should be "ARM_TARGET=armeabi" for the Android emulator and "ARM_TARGET=armeabi-v7a" for an Android device
...
# Internal options
set(CMAKETOOLS_TARGET_ARCH	${ANDROID_NDK_ABI_NAME})
