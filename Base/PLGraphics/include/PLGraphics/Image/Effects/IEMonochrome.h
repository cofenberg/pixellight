...
class IEMonochrome : public ImageEffect {
	...
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(PLGRAPHICS_RTTI_EXPORT, IEMonochrome, "PLGraphics", PLGraphics::ImageEffect, "Image effect: Convert color to grayscale using \"human eye formula\" (red*0.299 + green*0.587 + blue*0.114)")
	pl_class_end
