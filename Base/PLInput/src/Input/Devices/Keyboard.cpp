...
Keyboard::Keyboard(const String &sName, DeviceImpl *pImpl) : Device(sName, "Keyboard input controller", pImpl),
	...
	LeftWindows		(this, "LeftWindows",		"LeftWindows",							0x00),
	RightWindows	(this, "RightWindows",		"RightWindows",							0x00),
	Applications	(this, "Applications",		"Applications",							0x00),
	...
	LeftShift		(this, "LeftShift",			"LeftShift",							0x00),
	RightShift		(this, "RightShift",		"RightShift",							0x00),
	LeftControl		(this, "LeftControl",		"LeftControl",							0x00),
	RightControl	(this, "RightControl",		"RightControl",							0x00),
	VolumeMute		(this, "VolumeMute",		"VolumeMute",							0x00),
	VolumeDown		(this, "VolumeDown",		"VolumeDown",							0x00),
	VolumeUp		(this, "VolumeUp",			"VolumeUp",								0x00),
	MediaNextTrack		(this, "MediaNextTrack",		"MediaNextTrack",				0x00),
	MediaPreviousTrack	(this, "MediaPreviousTrack",	"MediaPreviousTrack",			0x00),
	MediaStop			(this, "MediaStop",				"MediaStop",					0x00),
	MediaPlayPause		(this, "MediaPlayPause",		"MediaPlayPause",				0x00),
