...
#ifndef __PLRENDERER_TEXTUREBUFFER2DARRAY_H__
#define __PLRENDERER_TEXTUREBUFFER2DARRAY_H__
#pragma once
...
class TextureBuffer2DArray : public TextureBuffer {
	...
	public:
		...
		*    Destructor
		*/
		PLRENDERER_API virtual ~TextureBuffer2DArray();
	...
	private:
		...
		*    Source to copy from
		*/
		TextureBuffer2DArray(const TextureBuffer2DArray &cSource);
		...
		*/
		TextureBuffer2DArray &operator =(const TextureBuffer2DArray &cSource);
...
#endif // __PLRENDERER_TEXTUREBUFFER2DARRAY_H__
