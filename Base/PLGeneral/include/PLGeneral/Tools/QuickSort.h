...
#ifndef __PLGENERAL_QUICKSORT_H__
#define __PLGENERAL_QUICKSORT_H__
#pragma once
...
class QuickSort {
	...
	public:
		...
		*    Constructor
		*/
		PLGENERAL_API QuickSort();

		/**
		*  @brief
		*    Destructor
		*/
		PLGENERAL_API virtual ~QuickSort();
		...
		*/
		PLGENERAL_API bool Sort(void *pData, uint32 nNumOfElements, uint32 nElementSize);
...
#endif // __PLGENERAL_QUICKSORT_H__
