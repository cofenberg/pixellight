...
... even more combinations are possible - you can also tweak the parameters of the effect material. You can use the sample application \emph{65PostProcess} to see this effects in action or to test out new, own effects.
