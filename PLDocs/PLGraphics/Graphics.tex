...
\section{Overview}
The heart of the PLGraphics component is the extensive image class. Additionally classes for various image effects are offered as well as classes for dealing with RGB and RGBA colors.
