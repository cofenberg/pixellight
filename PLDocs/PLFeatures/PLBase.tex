...
\item{Supported script features are global variables, global functions\footnote{C++ calls script and script calls C++} and RTTI objects\footnote{Properties, attributes, methods, signals}}
