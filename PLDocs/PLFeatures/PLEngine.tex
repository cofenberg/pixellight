...
\item{Mipmaps and texture compression support\footnote{DXT1, DXT3, DXT5, LATC1 and LATC2}. These can be created automatically on the fly or used from given dds data, for instance, for maximum control and best loading times.}
...
\item{Normal map compression using swizzled DXT5 (xGxR), LATC2\footnote{Formally \emph{3DC}/\emph{ATI1N}/\emph{ATI2N} on ATI GPU's only} and alternate XY swizzle LATC2 is supported}
\end{itemize}
