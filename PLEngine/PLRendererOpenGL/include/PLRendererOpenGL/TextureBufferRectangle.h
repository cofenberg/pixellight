...
#ifndef __PLRENDEREROPENGL_TEXTUREBUFFERRECTANGLE_H__
#define __PLRENDEREROPENGL_TEXTUREBUFFERRECTANGLE_H__
#pragma once
...
/**
*  @brief
*    OpenGL rectangle texture buffer resource
*/
class TextureBufferRectangle : public PLRenderer::TextureBufferRectangle {
	...
	private:
		...
		*      create function
		*/
		TextureBufferRectangle(PLRenderer::Renderer &cRenderer, PLGraphics::Image &cImage, EPixelFormat nInternalFormat, PLGeneral::uint32 nFlags);
		...
		*    Texture buffer flags (see EFlags)
		*/
		TextureBufferRectangle(PLRenderer::Renderer &cRenderer, const PLMath::Vector2i &vSize, EPixelFormat nInternalFormat, PLGeneral::uint32 nFlags);
...
#endif // __PLRENDEREROPENGL_TEXTUREBUFFERRECTANGLE_H__
