...
#ifndef __PLSCENE_COMPOSITING_GENERAL_END_H__
#define __PLSCENE_COMPOSITING_GENERAL_END_H__
#pragma once
...
*/
class SRPEnd : public SceneRendererPass {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(PLS_RTTI_EXPORT, SRPEnd, "PLScene", PLScene::SceneRendererPass, "Abstract finishing scene renderer pass")
...
#endif // __PLSCENE_COMPOSITING_GENERAL_END_H__
