...
#ifndef __PLSCENE_COMPOSITING_GENERAL_BEGIN_H__
#define __PLSCENE_COMPOSITING_GENERAL_BEGIN_H__
#pragma once
...
*/
class SRPBegin : public SceneRendererPass {
	...
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(PLS_RTTI_EXPORT, SRPBegin, "PLScene", PLScene::SceneRendererPass, "First scene renderer pass")
	...
	public:
		...
		*/
		PLS_API PLRenderer::Surface *GetOriginalRenderTarget() const;
		...
		*/
		PLS_API PLRenderer::SurfaceTextureBuffer *GetFrontRenderTarget() const;
		...
		*/
		PLS_API PLRenderer::SurfaceTextureBuffer *GetBackRenderTarget() const;

		/**
		*  @brief
		*    Swaps the render targets
		*/
		PLS_API void SwapRenderTargets();


	//[-------------------------------------------------------]
	//[ Protected virtual SceneRendererPass functions         ]
	//[-------------------------------------------------------]
	protected:
...
#endif // __PLSCENE_COMPOSITING_GENERAL_BEGIN_H__
