...
#ifndef __PLSCENE_COMPOSITING_GENERAL_LIGHTEFFECTS_H__
#define __PLSCENE_COMPOSITING_GENERAL_LIGHTEFFECTS_H__
#pragma once
...
*/
class SRPLightEffects : public SceneRendererPass {
	...
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(PLS_RTTI_EXPORT, SRPLightEffects, "PLScene", PLScene::SceneRendererPass, "Abstract scene renderer pass drawing light effects like lens flares")
	...
	public:
		...
		*    Cull query to use
		*/
		PLS_API virtual void Prepare(PLRenderer::Renderer &cRenderer, const SQCull &cCullQuery) = 0;
	...
	protected:
		...
		*    Default constructor
		*/
		PLS_API SRPLightEffects();

		/**
		*  @brief
		*    Destructur
		*/
		PLS_API virtual ~SRPLightEffects();
...
#endif // __PLSCENE_COMPOSITING_GENERAL_LIGHTEFFECTS_H__
