...
#ifndef __PLSCENE_COMPOSITING_GENERAL_DIFFUSEONLY_H__
#define __PLSCENE_COMPOSITING_GENERAL_DIFFUSEONLY_H__
#pragma once
...
*/
class SRPDiffuseOnly : public SceneRendererPass {
	...
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(PLS_RTTI_EXPORT, SRPDiffuseOnly, "PLScene", PLScene::SceneRendererPass, "Abstract diffuse only scene renderer pass, can also be used as depth only renderer pass")
	...
	protected:
		...
		*    Default constructor
		*/
		PLS_API SRPDiffuseOnly();

		/**
		*  @brief
		*    Destructur
		*/
		PLS_API virtual ~SRPDiffuseOnly();
...
#endif // __PLSCENE_COMPOSITING_GENERAL_DIFFUSEONLY_H__
