...
#ifndef __PLSCENE_COMPOSITING_GENERAL_DIRECTIONALLIGHTING_H__
#define __PLSCENE_COMPOSITING_GENERAL_DIRECTIONALLIGHTING_H__
#pragma once
...
*    rendering pipeline.
*/
class SRPDirectionalLighting : public SceneRendererPass {
	...
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(PLS_RTTI_EXPORT, SRPDirectionalLighting, "PLScene", PLScene::SceneRendererPass, "Abstract directional lighting scene renderer pass")
	...
	protected:
		...
		*    Default constructor
		*/
		PLS_API SRPDirectionalLighting();

		/**
		*  @brief
		*    Destructur
		*/
		PLS_API virtual ~SRPDirectionalLighting();
		...
		*    Texture stage
		*/
		PLS_API void SetupTextureFiltering(PLRenderer::Renderer &cRenderer, PLGeneral::uint32 nStage) const;
		...
		*    Cull query to use
		*/
		PLS_API void DrawRec(PLRenderer::Renderer &cRenderer, const SQCull &cCullQuery);
		...
		*/
		PLS_API const VisNode *GetFirstDirectionalLight(const SQCull &cCullQuery) const;
	...
	protected:
		...
		*/
		virtual void DrawMesh(PLRenderer::Renderer &cRenderer, const SQCull &cCullQuery, const VisNode &cVisNode, SceneNode &cSceneNode, const PLMesh::MeshHandler &cMeshHandler, const PLMesh::Mesh &cMesh, const PLMesh::MeshLODLevel &cMeshLODLevel, PLRenderer::VertexBuffer &cVertexBuffer) = 0;
	...
	private:
		...
		*    Visibility node referencing the first visible directional light scene node, NULL if no such scene node was found
		*/
		const VisNode *GetFirstDirectionalLightRec(const SQCull &cCullQuery) const;
...
#endif // __PLSCENE_COMPOSITING_GENERAL_DIRECTIONALLIGHTING_H__
