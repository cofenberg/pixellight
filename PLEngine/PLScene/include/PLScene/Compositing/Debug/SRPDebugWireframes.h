...
#ifndef __PLSCENE_COMPOSITING_DEBUG_WIREFRAMES_H__
#define __PLSCENE_COMPOSITING_DEBUG_WIREFRAMES_H__
#pragma once
...
class SRPDebugWireframes : public SRPDebug {
	...
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(PLS_RTTI_EXPORT, SRPDebugWireframes, "PLScene", PLScene::SRPDebug, "Abstract scene renderer pass drawing just simple wireframes")
	...
	protected:
		...
		*    Default constructor
		*/
		PLS_API SRPDebugWireframes();

		/**
		*  @brief
		*    Destructur
		*/
		PLS_API virtual ~SRPDebugWireframes();
...
#endif // __PLSCENE_COMPOSITING_DEBUG_WIREFRAMES_H__
