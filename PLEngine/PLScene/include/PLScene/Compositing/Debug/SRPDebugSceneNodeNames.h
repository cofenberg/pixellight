...
#ifndef __PLSCENE_COMPOSITING_DEBUG_SCENENODENAMES_H__
#define __PLSCENE_COMPOSITING_DEBUG_SCENENODENAMES_H__
#pragma once
...
class SRPDebugSceneNodeNames : public SRPDebug {
	...
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(PLS_RTTI_EXPORT, SRPDebugSceneNodeNames, "PLScene", PLScene::SRPDebug, "Scene renderer pass drawing just simple scene node names")
	...
	public:
		...
		*    Default constructor
		*/
		PLS_API SRPDebugSceneNodeNames();

		/**
		*  @brief
		*    Destructur
		*/
		PLS_API virtual ~SRPDebugSceneNodeNames();
	...
	private:
		...
		*    Cull query to use
		*/
		void DrawRec(PLRenderer::Font &cFont, const SQCull &cCullQuery) const;
		...
		*    Scene node to use
		*/
		void DrawName(PLRenderer::Font &cFont, const SQCull &cCullQuery, const VisNode &cVisNode, const SceneNode &cSceneNode) const;
...
#endif // __PLSCENE_COMPOSITING_DEBUG_SCENENODENAMES_H__
