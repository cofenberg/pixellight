...
#ifndef __PLSCENE_COMPOSITING_POSTPROCESSING_POSTPROCESSLOADER_PL_H__
#define __PLSCENE_COMPOSITING_POSTPROCESSING_POSTPROCESSLOADER_PL_H__
#pragma once
...
class PostProcessLoaderPL : public PostProcessLoader {
	...
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(PLS_RTTI_EXPORT, PostProcessLoaderPL, "PLScene", PLScene::PostProcessLoader, "Post process loader implementation for the PixelLight post process XML file format")
		pl_properties
	...
	//[-------------------------------------------------------]
	public:
		PLS_API bool Load(PostProcessManager &cPostProcessManager, PLGeneral::File &cFile);
		PLS_API bool Save(PostProcessManager &cPostProcessManager, PLGeneral::File &cFile);
	...
	public:
		...
		*    Default constructor
		*/
		PLS_API PostProcessLoaderPL();

		/**
		*  @brief
		*    Destructor
		*/
		PLS_API virtual ~PostProcessLoaderPL();
...
#endif // __PLSCENE_COMPOSITING_POSTPROCESSING_POSTPROCESSLOADER_PL_H__
