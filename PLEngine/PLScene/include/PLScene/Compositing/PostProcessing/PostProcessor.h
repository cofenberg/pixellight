...
#ifndef __PLSCENE_COMPOSITING_POSTPROCESSING_POSTPROCESSOR_H__
#define __PLSCENE_COMPOSITING_POSTPROCESSING_POSTPROCESSOR_H__
#pragma once
...
class PostProcessor {
	...
	public:
		...
		*    Constructor
		*/
		PLS_API PostProcessor();

		/**
		*  @brief
		*    Destructor
		*/
		PLS_API virtual ~PostProcessor();
		...
		*/
		PLS_API bool IsProcessing() const;
		...
		*/
		PLS_API bool BeginProcessing(PLRenderer::Renderer &cRenderer, PLRenderer::SurfaceTextureBuffer &cColorSurface);
		...
		*    'true' if all went fine, else 'false'
		*/
		PLS_API bool DrawResult(PLRenderer::Renderer &cRenderer, float fX1 = 0.0f, float fY1 = 0.0f,
		...
		*/
		PLS_API PLRenderer::SurfaceTextureBuffer *GetCurrentSurface() const;
...
#endif // __PLSCENE_COMPOSITING_POSTPROCESSING_POSTPROCESSOR_H__
