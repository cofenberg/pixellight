...
#ifndef __PLRENDERER_FONTTEXTURE_H__
#define __PLRENDERER_FONTTEXTURE_H__
#pragma once
...
class FontTexture : public Font {
	...
	public:
		...
		*    Destructor
		*/
		PLRENDERER_API virtual ~FontTexture();
	...
	private:
		...
		*    Source to copy from
		*/
		FontTexture(const FontTexture &cSource);
		...
		*/
		FontTexture &operator =(const FontTexture &cSource);
...
#endif // __PLRENDERER_FONTTEXTURE_H__
