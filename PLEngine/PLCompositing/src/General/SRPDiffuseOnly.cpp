...
#include "PLCompositing/General/SRPDiffuseOnly.h"
...
//[-------------------------------------------------------]
void SRPDiffuseOnly::DrawMesh(Renderer &cRenderer, const SQCull &cCullQuery, const VisNode &cVisNode, SceneNode &cSceneNode, const MeshHandler &cMeshHandler, const Mesh &cMesh, const MeshLODLevel &cMeshLODLevel, VertexBuffer &cVertexBuffer)
{
	// Get buffers
...
//[-------------------------------------------------------]
void SRPDiffuseOnly::Draw(Renderer &cRenderer, const SQCull &cCullQuery)
{
