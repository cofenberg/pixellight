...
class SRPDirectionalLightingShadersMaterial {
	...
	public:
		...
		*/
		// [TODO] Comments
		GeneratedProgramUserData *MakeMaterialCurrent(PLGeneral::uint32 nFlags, ETextureFiltering nTextureFiltering, bool bLightingEnabled, bool bGlowEnabled, float fDOFBlurrinessCutoff);
	...
	private:
		...
		*/
		// [TODO] Comments
		void Synchronize(PLGeneral::uint32 nFlags, bool bLightingEnabled, bool bGlowEnabled, float fDOFBlurrinessCutoff);
	...
	private:
		...
		PLGeneral::uint32					 m_nFlags;				/**< Used SRPDirectionalLightingShaders-flags */
