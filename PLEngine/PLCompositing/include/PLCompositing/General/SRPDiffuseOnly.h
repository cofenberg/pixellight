...
*  @endverbatim
*/
class SRPDiffuseOnly : public PLScene::SRPDiffuseOnly {
	...
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(PLCOM_RTTI_EXPORT, SRPDiffuseOnly, "PLCompositing", PLScene::SRPDiffuseOnly, "Shaders based diffuse only scene renderer pass implementation, can also be used as depth only renderer pass")
