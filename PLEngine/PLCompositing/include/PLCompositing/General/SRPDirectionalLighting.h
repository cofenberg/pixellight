...
*/
class SRPDirectionalLighting : public PLScene::SRPDirectionalLighting {
	...
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(PLCOM_RTTI_EXPORT, SRPDirectionalLighting, "PLCompositing", PLScene::SRPDirectionalLighting, "Shaders based diffuse only scene renderer pass implementation")
