...
#ifndef __PLPHYSICSNULL_BODYELLIPSOID_H__
#define __PLPHYSICSNULL_BODYELLIPSOID_H__
#pragma once
...
/**
*  @brief
*    Null physics ellipsoid body implementation
*/
class BodyEllipsoid : public PLPhysics::BodyEllipsoid {
	...
	public:
		...
		*    Destructor
		*/
		PLPHYSICSNULL_API virtual ~BodyEllipsoid();
...
#endif // __PLPHYSICSNULL_BODYELLIPSOID_H__
