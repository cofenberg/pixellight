...
class RenderApplication : public PLGui::GuiApplication {
	...
	pl_class(PL_RTTI_EXPORT, RenderApplication, "PLEngine", PLGui::GuiApplication, "Render application class")
			...
			// Methods
			pl_method_0(GetPainter,			pl_ret_type(PLRenderer::SurfacePainter*),									"Get surface painter of the main window. Returns pointer to surface painter of the main window (can be a null pointer)",																																																																																															"")
			pl_method_1(SetPainter,			pl_ret_type(void),							PLRenderer::SurfacePainter*,	"Set surface painter of the main window, pointer to surface painter of the main window (can be a null pointer) as first parameter",																																																																																													"")
			pl_method_0(GetInputController,	pl_ret_type(PLInput::VirtualController*),									"Get virtual input controller (can be a null pointer)",																																																																																																																"")
			pl_method_1(SetInputController,	pl_ret_type(void),							PLInput::VirtualController*,	"Set virtual input controller, virtual input controller (can be a null pointer) as first parameter",																																																																																																				"")
