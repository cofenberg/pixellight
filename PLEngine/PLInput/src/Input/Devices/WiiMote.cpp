...
WiiMote::WiiMote(const String &sName, DeviceImpl *pImpl) : Device(sName, "WiiMote controller", pImpl),
	...
	ButtonMinus		(this, "Minus",				"Button 'Minus'"),
	ButtonPlus		(this, "Plus",				"Button 'Plus'"),
	ButtonHome		(this, "Home",				"Button 'Home'"),
	ButtonLeft		(this, "Left",				"Button 'Left'"),
	ButtonRight		(this, "Right",				"Button 'Right'"),
	ButtonUp		(this, "Up",				"Button 'Up'"),
	ButtonDown		(this, "Down",				"Button 'Down'"),
	...
	NunchukButtonC	(this, "ButtonC",			"Nunchuk button 'C'"),
	NunchukButtonZ	(this, "ButtonZ",			"Nunchuk button 'Z'"),
