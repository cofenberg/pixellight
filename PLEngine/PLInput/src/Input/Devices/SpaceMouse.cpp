	...
	if (pInputBuffer) {
		...
		switch (pInputBuffer[0]) {
			...
			case 0x01:
			{
				...
				if (TransX.GetValue() != fTransX) TransX.SetValue(fTransX);
				if (TransY.GetValue() != fTransY) TransY.SetValue(fTransY);
				if (TransZ.GetValue() != fTransZ) TransZ.SetValue(fTransZ);
				break;
			}
			...
			case 0x02:
			{
				...
				if (RotX.GetValue() != fRotX) RotX.SetValue(fRotX);
				if (RotY.GetValue() != fRotY) RotY.SetValue(fRotY);
				if (RotZ.GetValue() != fRotZ) RotZ.SetValue(fRotZ);
				break;
			}
