...
#ifndef __PLRENDERERNULL_TEXTUREBUFFER1D_H__
#define __PLRENDERERNULL_TEXTUREBUFFER1D_H__
#pragma once
...
/**
*  @brief
*    Null 1D texture buffer resource
*/
...
#endif // __PLRENDERERNULL_TEXTUREBUFFER1D_H__
