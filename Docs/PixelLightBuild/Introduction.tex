...
\end{quotation}
you might want to check your firewall settings. Additionally you can browser the Git repository within your web browser by opening  \url{pixellight.git.sourceforge.net/git/gitweb.cgi?p=pixellight/pixellight;a=summary} to ensure that the server is not down (doesn't happen that often).
