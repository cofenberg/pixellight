...
In case you get the error message \begin{quote}Could NOT find Qt4 (missing: QT_QMAKE_EXECUTABLE\end{quote}, ensure that the files within the \emph{External/Optional/Qt/Linux_x86/} directory are executable (file permissions).
