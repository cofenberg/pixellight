...
Write \emph{<RTTI object>:GetAppDirectory()} in order to receive the directory of application executable (e.g. on Windows: "C:/MyApplication", can be an empty string).
