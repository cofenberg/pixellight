...
#ifndef __PLTESTBASE_GENERAL_CHECKSUMTEST_H__
#define __PLTESTBASE_GENERAL_CHECKSUMTEST_H__
#pragma once
...
/**
*  @brief
*    Abstract checksum base class for function tests
*/
class ChecksumTest : public TestCase {
	...
	private:
		...
		*    Checksum to use
		*  @param[in] sFilename
		*    Name of the file to get the checksum from
		*
		*  @return
...
#endif // __PLTESTBASE_GENERAL_CHECKSUMTEST_H__
