...
*/
SPK_PLLineTrailRendererShaders *SPK_PLLineTrailRendererShaders::Create(PLRenderer::Renderer &cRenderer)
{
	SPK_PLLineTrailRendererShaders *pSPK_PLLineTrailRendererShaders = new SPK_PLLineTrailRendererShaders(cRenderer);
...
//[ Public functions                                      ]
//[-------------------------------------------------------]
SPK_PLLineTrailRendererShaders::SPK_PLLineTrailRendererShaders(PLRenderer::Renderer &cRenderer) : SPK_PLLineTrailRenderer(cRenderer)
{
}
