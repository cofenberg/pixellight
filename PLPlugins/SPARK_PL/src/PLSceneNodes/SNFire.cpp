...
void SNFire::InitFunction()
{
	...
	// Renderers
	SPK_PLQuadRenderer *pFireRenderer = SPK_PLQuadRendererFixedFunctions::Create(cRenderer);
	...
	SPK_PLQuadRenderer *pSmokeRenderer = SPK_PLQuadRendererFixedFunctions::Create(cRenderer);
