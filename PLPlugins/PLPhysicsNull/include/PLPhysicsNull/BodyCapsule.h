...
#ifndef __PLPHYSICSNULL_BODYCAPSULE_H__
#define __PLPHYSICSNULL_BODYCAPSULE_H__
#pragma once
...
/**
*  @brief
*    Null physics capsule body implementation
*/
class BodyCapsule : public PLPhysics::BodyCapsule {
	...
	public:
		...
		*    Destructor
		*/
		PLPHYSICSNULL_API virtual ~BodyCapsule();
...
#endif // __PLPHYSICSNULL_BODYCAPSULE_H__
