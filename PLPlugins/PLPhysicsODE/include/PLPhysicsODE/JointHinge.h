...
#ifndef __PLPHYSICSODE_JOINTHINGE_H__
#define __PLPHYSICSODE_JOINTHINGE_H__
#pragma once
...
/**
*  @brief
*    ODE physics hinge joint implementation
*/
class JointHinge : public PLPhysics::JointHinge {
	...
	public:
		...
		*    Destructor
		*/
		PLPHYSICSODE_API virtual ~JointHinge();
...
#endif // __PLPHYSICSODE_JOINTHINGE_H__
