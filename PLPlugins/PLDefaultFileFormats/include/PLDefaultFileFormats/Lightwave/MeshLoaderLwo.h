...
#ifndef __PLDEFAULTFILEFORMATS_LIGHTWAVE_MESHLOADER_LWO_H__
#define __PLDEFAULTFILEFORMATS_LIGHTWAVE_MESHLOADER_LWO_H__
#pragma once
...
/**
*  @brief
*    Mesh loader implementation for lwo2 (Lightwave 6+)
*
* @see
*  - LWO2 format specifications:
*    http://www.newtek.com/products/lightwave/developer/LW80/8lwsdk/docs/filefmts/lwo2.html
*/
class MeshLoaderLwo : public PLMesh::MeshLoader {
...
#endif // __PLDEFAULTFILEFORMATS_LIGHTWAVE_MESHLOADER_LWO_H__
