...
*/
class SNMPostProcessCombineMultiplicate : public PLScene::SNMPostProcess {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, SNMPostProcessCombineMultiplicate, "PLPostProcessEffects", PLScene::SNMPostProcess, "")
