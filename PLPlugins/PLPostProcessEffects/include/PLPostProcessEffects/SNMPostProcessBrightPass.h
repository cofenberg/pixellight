...
*/
class SNMPostProcessBrightPass : public PLScene::SNMPostProcess {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, SNMPostProcessBrightPass, "PLPostProcessEffects", PLScene::SNMPostProcess, "")
