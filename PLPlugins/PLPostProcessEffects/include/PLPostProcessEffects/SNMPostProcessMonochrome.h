...
*    Monochromes colors.
*/
class SNMPostProcessMonochrome : public PLScene::SNMPostProcess {


	//[-------------------------------------------------------]
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, SNMPostProcessMonochrome, "PLPostProcessEffects", PLScene::SNMPostProcess, "")
